...
app.listen(5000) // app object uses express listen function to create server
//  use next to travel from middleware to middleware if you did not return response
